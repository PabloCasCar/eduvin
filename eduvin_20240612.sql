...
INSERT INTO `produtos` (`id`, `nome`, `descricao`, `preco`, `quantidade_estoque`, `tipo`, `imagem`) VALUES
(1, 'T-shirt Vintage', 'Jimmy from NBA', '17.99', 50, 'roupa', 'tshirts.png'),
(2, 'Calça Jeans', 'Calça jeans azul', '59.99', 30, 'roupa', 'calcas.png'),
(3, 'Acessorios vintage', 'Acessorios: Aneis, correntes, pulseiras e brincos', '10.00', 200, 'ace-cal', 'acessorios.png'),
(4, 'Calçados vintage', 'Calçados: dos tamanhos 20 até ao 50', '60.00', 20, 'ace-cal', 'sapatilhas-p-6000-2FBrXk.png');
